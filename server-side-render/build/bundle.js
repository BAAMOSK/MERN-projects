...
app.get('*', function (req, res) {
    ...
    //ALL loadDATA functions have reference to server STORE
    ...
    //PROMISE = CHECK TO MAKE SURE DATA IS RECIEVED BY SERVER BEFORE RENDERING ON CLIENT
    Promise.all(promises).then(function () {
        var context = {};
        var content = (0, _renderer2.default)(req, store, context);

        //CONTEXT COMES FROM REDIRECT COMPONENT
        //console.log(context);
        if (context.url) {
...
//THIS HELPS THE SERVER KNOW WHICH COMPONENT TO RENDER
//PASS STORE FROM SERVER
