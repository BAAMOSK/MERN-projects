                ...
                <div class="loader-section" v-if="loading">
                    ...
                    <div class="user-list">
                        <div class="columns">
                            ...
                            <div class="column is4 right">
                                <router-link class="button is-primary"
                                to="/user">View Person</router-link>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="columns">
                            ...
                            <div class="column is-8">
                                ...
                                <div class="inner">
                                    ...
                                    <div class="right">
                                        <p class="user-list__sub"><strong>Phone
                                        Number</strong>: {{person.phonenumber}}</p>
                                    </div>
                            ...
                            <div class="column is-4 right">
                                <router-link class="button is-primary"
                                v-bind:to="{ name: 'view-contact', params: {
                                person: person.slug }}">View Person</router-link>
                            </div>

                        </div>
                     </div><!-- closes user-list -->

                </div><!-- closes loader-section -->
...
<!-- <style lang="scss" scoped>
    ...
    .animated-background__header {
        ...
        color-stop(8%, #eee), color-stop(18%, #ddd), color-stop(33%, #eee));
